...
def setup_credentials():
    ...
    credentials = {
        ...
        "THERMOMETER_ENABLED": input("Enable thermometer? [true/false] (default 'false'): ").strip().lower() or "false",
        "THERMOMETER_PORT": input("Thermometer port (e.g., COM5) (default 'COM5'): ").strip() or "COM5",
        "THERMOMETER_BAUD": input("Thermometer baud rate (default '115200'): ").strip() or "115200",
        "THERMOMETER_RECONNECT_SECONDS": input("Thermometer reconnect delay in seconds (default '2.0'): ").strip() or "2.0"
    }
